...
from .views import NinoViewSet, TutorViewSet, NinoTutorViewSet, PersonaAutorizadaViewSet, DocumentoViewSet

router = DefaultRouter()
router.register(r'ninos',         NinoViewSet,              basename='nino')
router.register(r'tutores',       TutorViewSet,             basename='tutor')
router.register(r'tutores-nino',  NinoTutorViewSet,         basename='nino-tutor')
